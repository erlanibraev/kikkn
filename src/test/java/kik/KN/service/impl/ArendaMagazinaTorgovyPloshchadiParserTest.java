...
public class ArendaMagazinaTorgovyPloshchadiParserTest {

    @Autowired
    private ArendaMagazinaTorgovyPloshchadiParser arendaMagazinaTorgovyPloshchadiParser;

    @Test
    public void test01() throws IOException {
        arendaMagazinaTorgovyPloshchadiParser.setOneDay(false);
        List<String> cities = arendaMagazinaTorgovyPloshchadiParser.getCitiesUrls(arendaMagazinaTorgovyPloshchadiParser.getScanType());
        List<MCommercial> result = arendaMagazinaTorgovyPloshchadiParser
