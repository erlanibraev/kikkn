...
public class MCommercial {
    ...
    private Integer sotoreysNumber;
    private Long condition;
    private Long wallType;
    private Double ceilingHeight;
    private Long heatingType;
    private Long waterSuppleType;
    ...
    public Integer getSotoreysNumber() {
        return sotoreysNumber;
    }

    public void setSotoreysNumber(Integer sotoreysNumber) {
        this.sotoreysNumber = sotoreysNumber;
    }
    ...
    public Long getWaterSuppleType() {
        return waterSuppleType;
    }

    public void setWaterSuppleType(Long waterSuppleType) {
        this.waterSuppleType = waterSuppleType;
    }
