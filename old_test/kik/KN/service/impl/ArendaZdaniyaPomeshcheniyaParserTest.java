...
public class ArendaZdaniyaPomeshcheniyaParserTest {

    @Autowired
    private ArendaZdaniyaPomeshcheniyaParser arendaZdaniyaPomeshcheniyaParser;

    @Test
    public void test01() throws IOException {
        arendaZdaniyaPomeshcheniyaParser.setOneDay(false);
        List<String> cities = arendaZdaniyaPomeshcheniyaParser.getCitiesUrls(arendaZdaniyaPomeshcheniyaParser.getScanType());
        List<MCommercial> result = arendaZdaniyaPomeshcheniyaParser
