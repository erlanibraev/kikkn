...
public class ArendaOfisaParserTest {

    @Autowired
    private ArendaOfisaParser arendaOfisaParser;


    @Test
    public void test01() throws IOException {
        List<String> cities = arendaOfisaParser.getCitiesUrls(arendaOfisaParser.getScanType());
        List<MCommercial> result = arendaOfisaParser
